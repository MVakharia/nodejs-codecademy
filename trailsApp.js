...
getTrailDistancePromise('North Country')
    .then((foundTrail) => {const nickname = foundTrail.nickname;
        const mi = foundTrail.miles;

        console.log(`The ${nickname} is ${mi} miles long!`)
    }

).catch(error => console.log('Trail not found.', error));

const w3schoolsUtilGuide = "https://www.w3schools.com/nodejs/nodejs_util.asp";
